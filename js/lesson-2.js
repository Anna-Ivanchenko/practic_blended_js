...
// знаходимо індекс 'blues'
const ind = styles.indexOf('blues');
console.log(ind);

// якщо елемент знайдено — замінюємо
if (ind !== -1) {
  styles[ind] = 'classic';
}
console.log(styles);
...
// const logins = ["Peter", "John", "Igor", "Sasha", "Nastka"];
...
console.log(calculateAverage(10, '5', 20));       // 15
console.log(calculateAverage('a', true));         // No numbers provided
...
// Якщо вказані властивості в обʼєкті відсутні 
// (тобто метод exist повертає false),
...
console.log(calcTotalPrice(fruits, "Манго")); // 0
console.log(calcTotalPrice(fruits, "Апельсин")); // 0
console.log(calcTotalPrice(fruits, "Груша")); // 0
console.log(calcTotalPrice(fruits, "Виноград")); // 0